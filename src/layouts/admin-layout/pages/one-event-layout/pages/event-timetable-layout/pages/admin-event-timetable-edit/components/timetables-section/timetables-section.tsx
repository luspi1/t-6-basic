import { type EventTimetableInputs } from 'src/layouts/admin-layout/pages/one-event-layout/pages/event-timetable-layout/pages/admin-event-timetable-edit/schema'
